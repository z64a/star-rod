...
public enum Options
{
	...
	MapUndoLimit		(true, Scope.MapEditor, Type.Integer, "UndoLimit", "32", "Undo Limit", "", 1.0),
	...
	SprWarnIrreversible		(true, Scope.SpriteEditor, Type.Boolean, "WarnIrreversible", "true", "Irreversible action warning",
