...
public class BadgeCellRenderer extends JPanel implements ListCellRenderer<ItemRecord>
{
	...
	public BadgeCellRenderer(GlobalsData globals)
	{
		...
		boolean cellHasFocus)
	{
		...
		if (item != null) {
			...
			idLabel.setText(String.format("%03X", item.sortValue));
